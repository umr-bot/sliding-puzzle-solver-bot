...
class env():
    ...
    def __init__(self,state='123456078',N=2):
        self.N = N
        self.state           = state
        ...
        #self.solvable_states = ['1203','0213','2013','2310','2301',
        #                   '1032','0132','3102','3120','3021','0321']
    ...
    def transpose(self, move=0):
        size = self.N**2
        #blank = self.blank # blank block is valued zero
    ...
    def gen_states(self):
        l=list(itertools.permutations('0123456789', 9))
...
### Check if number of solved states is correct
#cnt = 0 
#states = e.gen_states() 
#for s in states: 
#    e.state = s 
#    if e.is_solvable(): 
#        cnt += 1 
#print("number of solved states is:",cnt)
